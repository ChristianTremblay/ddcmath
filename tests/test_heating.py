...
def test_heating_cfm_farenheit():
    assert (
        abs_relative_error(heating_cfm(kw=1, delta_t_farenheit=3.15926), 1000) < 0.003
    )
...
def test_heating_ls_farenheit():
    assert (
        abs_relative_error(heating_ls(kw=1, delta_t_farenheit=3.15926), cfm2ls(1000))
        < 0.003
    )
...
def test_heating_ls_celsius():
    assert (
        abs_relative_error(heating_ls(kw=1, delta_t_celsius=1.7551), cfm2ls(1000))
        < 0.003
    )
...
def test_heating_kw_cfm_farenheit():
    assert (
        abs_relative_error(heating_kw(cfm=1000, delta_t_farenheit=3.15926), 1) < 0.003
    )
...
def test_heating_kw_ls_farenheit():
    assert (
        abs_relative_error(heating_kw(ls=cfm2ls(1000), delta_t_farenheit=3.15926), 1)
        < 0.003
    )
...
def test_heating_kw_ls_celsius():
    assert (
        abs_relative_error(heating_kw(ls=cfm2ls(1000), delta_t_celsius=1.7551), 1)
        < 0.003
    )
